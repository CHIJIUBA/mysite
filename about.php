<?php include("include/header.php") ?>
      ...
      <div class="container py-lg-5 py-md-4 py-2">
        <div class="row">
          <div class="col-lg-4 left-wthree-info align-self">
            ...
            <p class="">Highly motivated Backend Developer with a passion for creating efficient and scalable systems. Skilled in utilizing various programming languages including PHP, Python, and Node.js. Proficient in designing and implementing RESTful APIs, as well as working with databases like MySQL, PostgreSQL, and NoSQL.</p>
            ...
            <div class="about-pic-info mt-4">
              ...
              <div class="social-column-3 social-column-2 mt-3">
                ...
                <a href="https://www.linkedin.com/in/chijiuba-victory-a8865615a" target="_blank" class="facebook">
          ...
          <div class="col-lg-4 left-wthree-info px-lg-5 mt-lg-0 mt-5">
            ...
            <div class="left-wthree-img-inf mt-4">
              ...
              <p>Software Developer's Community, UNN</p>
            </div>
           <!--  <div class="left-wthree-img-inf mt-4">
              <h4 class="title">
        ...
        <div class="row circle-grids">
          ...
          <div class="col-lg-6 position-relative pl-lg-0">
            <div class="progress-circles">
              ...
              <div class="circle1">
                <div id="progress4" data-dimension="160" data-text="70%" data-fontsize="32" data-percent="70"
                  data-fgcolor="#6610f2" data-bgcolor="#eee" data-width="15" data-bordersize="5" data-animationstep="2">
                </div>
                <h4>MySQL</h4>
              </div>
  ...
  <script>
    ...
    title.innerHTML = "Chijiuba| About";
    $(function () {
